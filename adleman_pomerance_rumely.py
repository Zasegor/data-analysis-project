...
def adleman_pomerance_rumely_primality_test(N):
    t_list = [
        2,
        12,
        60,
...
if __name__ == '__main__':
    ...
    print(2 ** 521 - 1)
    #    adleman_pomerance_rumely_primality_test(2 ** 521 - 1)  # 157 digit, 18 sec
    adleman_pomerance_rumely_primality_test(2**1279-1)  # 386 digit, 355 sec
    #    adleman_pomerance_rumely_primality_test(2074722246773485207821695222107608587480996474721117292752992589912196684750549658310084416732550077)
